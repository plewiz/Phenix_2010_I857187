...
namespace Rivet
{
    ...
    class Phenix_2010_I857187 : public HeavyIonAnalysis
    {
    ...
    private:
        ...
        const int CENT_TYPE_EDGES[N_CENT_TYPES][1] = {{0,5},{60,90}; // 
        
        // histograms; Yours will almost certainly be different
        
        Histo1DPtr _h1_dp_pion_57g;
        Histo1DPtr _h2_dp_pion_79g;
        Histo1DPtr _h3_dp_pion_912g;
        Histo1DPtr _h4_dp_pion_1215g;
        
        Histo1DPtr _h5_dp_ipd_57g;
        Histo1DPtr _h6_dp_idp_79g;
        Histo1DPtr _h7_dp_idp_912g;
        Histo1DPtr _h8_dp_idp_1215g;
        
        Histo1DPtr _h9_dp_pion_57g;
        Histo1DPtr _h10_dp_pion_79g;
        Histo1DPtr _h11_dp_pion_912g;
        Histo1DPtr _h12_dp_pion_1215g;
        
        Histo1DPtr _h13_dp_ipd_57g;
        Histo1DPtr _h14_dp_idp_79g;
        Histo1DPtr _h15_dp_idp_912g;
        Histo1DPtr _h16_dp_idp_1215g;
        
        // Number of trigger particles for each centrality over
        //  all events. Needed in finalize() for normalization
        unsigned long long int nTrigger[2];
        
    public:
        /// Constructor
        Phenix_2010_I857187():HeavyIonAnalysis("Phenix_2010_I857187") {}
        ...
        void init()
        {
            ...
            Cuts cutTrigger = Cuts::abseta < 1.0 && ((Cuts::pid == pidPI0 && Cuts::pt > 8.0 * GeV && Cuts::pt < 15.0 * GeV) || (Cuts::pid == pidGAMMA && Cuts::pt > 1.0 * GeV && Cuts::pt < 10.0 * GeV))
            ...
            //  in finalize
            for (int i = 0; i < 1; ++i) nTrigger[i] = 0;
        }
